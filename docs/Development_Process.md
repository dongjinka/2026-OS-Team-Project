...
repo through **pull requests** (PR #1–#18 over the project — #12 was the English
deliverables landing, #13/#14 the audit fixes, #15 the 06-05 README/kernel-stack
landing, #17/#18 the 06-09 documentation consolidation). This gave every change
a review step and kept the trunk buildable.
